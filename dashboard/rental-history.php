        ...
        <table>
            ...
            <tbody>
                 <?php if (empty($rentals)): ?>
                     <tr><td colspan="12" class="text-center text-muted" style="padding: 2rem;">No rental records found</td></tr>
                <?php else: ?>
                            ...
                            <td>
                             ...
                             <td>
                                 <?php if ($r['status'] === 'pending' || $r['status'] === 'confirmed'): ?>
                                     <?php $balance = $r['total_amount'] - $r['total_paid']; ?>
                                     <?php if ($balance > 0): ?>
                                         <a href="<?php echo $base_url; ?>/dashboard/payments.php?action=new&booking_id=<?php echo $r['booking_id']; ?>"
                                            class="btn btn-sm btn-primary" title="Complete Payment">
                                             ✓ Finish Pending
                                         </a>
                                     <?php endif; ?>
                                 <?php endif; ?>
