...
if (isLoggedIn()) {
    header('Location: ' . getBaseUrl() . '/customer/index.php');
    exit();
}
    ...
    if (!isset($_POST['csrf_token']) || !hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
        ...
        if (empty($username) || empty($email) || empty($full_name) || empty($password)) {
            ...
            if (mysqli_stmt_num_rows($check_stmt) > 0) {
                ...
                try {
                    $insert_sql = "INSERT INTO users (username, email, full_name, password, role) VALUES (?, ?, ?, ?, 'customer')";
                    ...
                    $first_name = $names[0];
                    $last_name = isset($names[1]) ? $names[1] : 'N/A';

                    $insert_cust = "INSERT INTO customers (first_name, last_name, email, phone, address, city, state, zip_code)
                                   VALUES (?, ?, ?, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')";
                    $cust_stmt = mysqli_prepare($conn, $insert_cust);
                    mysqli_stmt_bind_param($cust_stmt, 'sss', $first_name, $last_name, $email);
...
<head>
    ...
    <title>Customer Registration - TRACKTOR</title>
    ...
    <style>
        ...
        .auth-bg {
            ...
            width: 100%;
            height: 100%;
            background-image: url('/tracktor/assets/image/2026-05-05/n6gqqwaaafna/John-Deere-Tractor-at-Night-1024x640.jpg');
        ...
        <div class="auth-card">
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="Customer" disabled style="opacity: 0.7;">
